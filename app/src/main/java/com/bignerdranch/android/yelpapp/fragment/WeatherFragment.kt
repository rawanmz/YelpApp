...
class WeatherFragment : Fragment() {
    ...
    fun bind() {
                ...
                val v= restaurantViewModel.searchResturantById(args.id).observe(viewLifecycleOwner,
                        Observer {
                            if (it != null) {


                                dayPlan = DayPlan(it.yelpId,it.name,it.rating,it.phone,
                                        it.is_closed,it.numReviews,it.distanceInMeters,it.imageUrl,it.categories,it.coordinates,it.listDescription)
